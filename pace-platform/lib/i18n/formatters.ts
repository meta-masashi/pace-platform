 ...
 *   - date.toLocaleString() は動作が不定なため禁止
 *
 * 使用例:
 *   formatCurrency(1980)
 *   // → '¥1,980'
 ...
 * 複数通貨対応: JPY（円）は小数点なし、USD/EUR は小数点2桁。
 *
 ...
 *
 * @example
 *   formatRelativeTime('2024-03-20T18:55:00Z')
 *   // → '5分前'
 */
...
export function formatPhoneNumber(value: string): string {
  ...
  // 市外局番3桁（03, 06 等）+ 市内番号7桁 = 10桁パターン（03-XXXX-XXXX）
  return value
}
 ...
 *
 * Next.js 等のフレームワークがある場合は next-intl を優先して使用すること。
